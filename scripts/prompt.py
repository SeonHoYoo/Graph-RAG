...
3. Placeholders with the same ID refer to the same real-world entity (e.g., every (ENT1) in the output must be the same entity).
4. If evidence is insufficient, keep the placeholder unchanged.
5. Each triplet must be wrapped in double quotes.
6. Separate triplets with comma + space: ", "
