...
#SBATCH --job-name=q-hotpot
#SBATCH --output=/home/hyeseojeon/data/graph/logs/extract/question_%x_%j.out
#SBATCH --error=/home/hyeseojeon/data/graph/logs/extract/question_%x_%j.err
...
#   DATASET=hotpotqa        sbatch --job-name=q-hotpotqa   question.sh
#   DATASET=2wikimultihopqa sbatch --job-name=q-2wiki      question.sh
#   DATASET=musique         sbatch --job-name=q-musique    question.sh
...
cmd=(
    /data3/hyeseojeon/.conda/envs/sllm3/bin/python -u scripts/extract/question.py
    --dataset "${DATASET}"
